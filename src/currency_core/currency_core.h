...
namespace currency
{
  ...
  /************************************************************************/
   ...
   public:
     ...
     virtual bool get_block_template(block& b, const account_public_address& adr, wide_difficulty_type& diffic, uint64_t& height, const blobdata& ex_nonce, const alias_info& ai);
