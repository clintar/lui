...
namespace currency
{
  ...
  //-----------------------------------------------------------------------------------------------
  bool core::get_block_template(block& b, const account_public_address& adr, wide_difficulty_type& diffic, uint64_t& height, const blobdata& ex_nonce, const alias_info& ai)
  {
    return m_blockchain_storage.create_block_template(b, adr, diffic, height, ex_nonce, ai);
  }
  //-----------------------------------------------------------------------------------------------
